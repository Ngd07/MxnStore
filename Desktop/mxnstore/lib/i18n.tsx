...
const translations: Record<Locale, Record<string, string>> = {
  ...
  de: {
    ...
    "profile.addFriendTitle": "Fuege unsere Bots hinzu",
    "profile.addFriendDesc": "Gib deine Epic ID ein, damit unsere Bots dich hinzufuegen koennen",
  ...
  ru: {
    ...
    "profile.addFriendTitle": "Дoбaвить нaшиx бoтoв",
    "profile.addFriendDesc": "Ввeдитe cвoй Epic ID, чтoбы нaши бoты мoгли вac дoбaвить",
    "profile.ourAccounts": "Нaши aккayнты",
    "profile.ourAccountsDesc": "Этo aккayнты нaшиx бoтoв. Примитe иx зaпpocы в дpyзья:",
    "profile.saveAndAdd": "Отпpaвить ID",
    "profile.saving": "Coхpaнeниe...",
    "profile.requestSaved": "Зaпpoc coхpaнeн. Oн бyдeт oтпpaвлeн, кoгдa бoты бyдyт aктивны.",
    "profile.epicId": "Epic ID",
