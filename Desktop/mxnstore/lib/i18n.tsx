...
const translations: Record<Locale, Record<string, string>> = {
  es: {
    ...
    "profile.copy": "Copiar",
    "profile.helpTextEs": "Acepta las solicitudes de amigo que te lleguen de nuestras cuentas. Despues de 48 horas de haber aceptado, podremos enviarte regalos.",
    "profile.helpTextEn": "Accept the friend requests from our accounts. After 48 hours of being accepted, we will be able to send you gifts.",
    "profile.helpTextDe": "Akzeptiere die Freundschaftsanfragen von unseren Konten. Nach 48 Stunden nach der Akzeptierung koennen wir dir Geschenke schicken.",
    "profile.helpTextRu": "Priniati zayavki v drugst ot nashikh akkauntov. Posle 48 chasov posle prinyatiya, my smozhem otpravit vam podarki.",
    ...
    "buy.cryptoPay": "Pagar con Crypto",
    "buy.manualPay": "Pagar manualmente",
    "buy.selectPayment": "Selecciona metodo de pago",
    "buy.cryptoProcessing": "Procesando pago crypto...",
    "buy.cryptoSuccess": "Pago iniciado. Seras redirigido automaticamente.",
    "buy.cryptoError": "Error al procesar pago crypto",
    "buy.cryptoWaiting": "Esperando pago...",
    "buy.cryptoComplete": "Pago completado!",
    "buy.orderId": "Orden #",
    "buy.bestPrice": "Mejor precio",
  ...
  de: {
    ...
    "buy.cryptoPay": "Pay with Crypto",
    "buy.manualPay": "Pay manually",
    "buy.selectPayment": "Select payment method",
    "buy.cryptoProcessing": "Processing crypto payment...",
    "buy.cryptoSuccess": "Payment initiated. You will be redirected automatically.",
    "buy.cryptoError": "Error processing crypto payment",
    "buy.cryptoWaiting": "Waiting for payment...",
    "buy.cryptoComplete": "Payment completed!",
    "buy.orderId": "Order #",
    "buy.bestPrice": "Best value",
