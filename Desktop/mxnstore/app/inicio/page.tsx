...
import { ShoppingBag, UserPlus, Coins, Zap, Shield, Clock, MessageCircle, ChevronRight } from "lucide-react";
      ...
      <section className="py-20 px-4">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="text-muted-foreground mb-8">
            Únete a nuestra comunidad en Discord y empieza a comprar hoy.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              onClick={() => router.push("/")}
              className="flex items-center justify-center gap-2 px-8 py-4 rounded-xl border border-border hover:bg-secondary transition-colors font-semibold"
            >
              <ShoppingBag className="h-5 w-5" />
              Ver Tienda
            </button>
        ...
        <div className="mx-auto max-w-7xl flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <Image
              ...
              className="rounded"
            />
            <span className="text-sm font-semibold">MxNStore</span>
          </div>
          
          <div className="flex items-center gap-4 text-sm text-muted-foreground">
            <Link href="/" className="hover:text-foreground transition-colors">Tienda</Link>
            <Link href="/buy-vbucks" className="hover:text-foreground transition-colors">Comprar</Link>
            <a href="https://discord.gg/nKs2jM7PNJ" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">Discord</a>
          </div>
          
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} MxNStore
          </p>
        </div>
      </footer>
    </div>
