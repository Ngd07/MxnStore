          ...
          <div className="prose prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                ...
                <li><strong>Producto defectuoso:</strong> Si el producto no funciona, we'll investigate y ofreceremos reemplazo o reembolso</li>
                <li><strong>Error en el nombre de usuario:</strong> Si proporcionaste el nombre correcto pero no se entregó, we'll reintentar la entrega sin costo adicional</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                ...
                <li><strong>Cuenta no encontrada:</strong> Si el nombre de Epic Games proporcionado no existe, we'll intentar contactarte</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                ...
                <li><strong>Skin/Cuenta comprada y canjeada:</strong> Las ventas de contenido digital son finales</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                ...
                <li>Las skins/cuentas pueden ser flaggedeadas por métodos de compra no autorizados</li>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground">
                Para solicitudes de reembolso, contáctanos a través de nuestro servidor de Discord. We're here para ayudar!
              </p>
            </section>
          </div>
        </main>
